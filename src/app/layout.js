...
export const metadata = {
  ...
  description: "Jogos online gratis no navegador! Wordle em portugues, 2048, Jogo da Memoria, Bubble Shooter, Deep Attack, Jogo do Jacare e mais. Sem download, jogue agora no celular ou computador!",
  keywords: ["jogos online gratis", "jogos no navegador", "jogos sem download", "wordle portugues", "2048 online", "jogo da memoria online", "bubble shooter online", "jogo do jacare", "frogger online", "jogos gratis", "jogos mobile", "jogos browser"],
  other: {
    "geo.region": "BR",
